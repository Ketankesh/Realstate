...
$c="create table sellproperties(id int NOT NULL auto_increment primary key,fname varchar(10) NOT NULL,lname varchar(10) NOT NULL,city varchar(10) NOT NULL,state varchar(10) NOT NULL,postalcode int(10) NOT NULL,text varchar(100) NOT NULL,price varchar(10) NOT NULL,images varchar(300) NOT NULL,datetime TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP  ON UPDATE CURRENT_TIMESTAMP
)";
...
if(isset($_POST["send"]))
{
  ...
  $ins="insert into sellproperties (fname,lname,city,state,postalcode,text,price,images) values('$fname','$lname','$city','$state','$postalcode','$text','$price','$fileuplod')";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 5%;">
            <div class="col">
                <form class="was-validated" action="" method="" enctype="multipart/form-data">
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        <label for="validationDefault01">First name</label>
                        <input type="text" class="form-control" name="fname" id="validationDefault01" value="first name" required>
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="validationDefault02">Last name</label>
                        <input type="text" class="form-control" name="lname" id="validationDefault02" value="last name" required>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="postalcode" id="validationDefault05" required>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="customControlValidation2" name="price" value="price" required>
                        <label class="custom-control-label" for="customControlValidation2">Fixed Rate</label>
                      </div>
                      <div class="custom-control custom-radio mb-3">
                        <input type="radio" class="custom-control-input" id="customControlValidation3" name="price" value="price" required>
                      ...
                      <div class="input-group is-invalid">
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" name="fileUpload[]" id="validatedInputGroupCustomFile" required>
                          <label class="custom-file-label" for="validatedInputGroupCustomFile">Choose files...</label>
                        </div>
                        <div class="input-group-append">
                           <button class="btn btn-outline-secondary" name="submit" type="submit">UPLOAD</button>
                        </div>
                      ...
                      <button class="btn btn-danger" name="send" type="submit">Submit</button>
                  </form>
            </div>
        </div>
    </div>
